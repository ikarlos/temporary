...
(function ($) {
	...
	// Function to handle reading and displaying uploaded image
...
// Event listener for Medical license input
$("#profile_image").change(function () {
    readURL(this, 'prof-avatar');
});

//event listener for degree
$("#quali_certificate").change(function () {
    readURL(this, 'degree_image');
});

// Event listener for Medical license input
$("#qualification-certificate").change(function () {
    readURL(this, 'med-life');
});

// Event listener for Photo ID input
$("#photo-id").change(function () {
    readURL(this, 'idproof');
});

// Event listener for Establishment proof input
$("#clinical_employment").change(function () {
    readURL(this, 'clinic');
});
